interface MatchInfoParticipantPerksStyleSelection {
  perk: number
  var1: number
  var2: number
  var3: number
...
interface MatchInfoParticipantPerksStyle {
  description: string
...
interface MatchInfoParticipantPerks {
  statPerks: StatPerks
  styles: MatchInfoParticipantPerksStyle[]
}

interface RiotMatchInfoParticipant {
  assists: number
  baronKills: number
  bountyLevel: number
...
interface MatchInfo {
  ...
  gameVersion: string
  mapId: number
  participants: RiotMatchInfoParticipant[]
  platformId: string
  queueId: number
  teams: MatchInfoTeam[]
